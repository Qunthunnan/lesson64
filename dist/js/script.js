...
function cards({
  ...
  function makeFoodMenu() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('http://localhost:3000/menu').then(result => {
      result.data.forEach(({
        img,
        altimg,
        title,
  ...
  let usdRate;
  axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?valcode=usd&json').then(result => {
...
function modals({
  ...
  let showModalInvId, closeModalInvId, autoOpenTimId;
  ...
  clientForm.addEventListener('submit', e => {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('http://localhost:3000/requests', Object.fromEntries(userData)).then(response => {
...
/* harmony import */ var _modules_foodCards__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/foodCards */ "./src/js/modules/foodCards.js");
...
(0,_modules_foodCards__WEBPACK_IMPORTED_MODULE_3__["default"])({
  menuWrapperSelector: '.menu__wrapper',
  menuItemClass: 'menu__item'
});
(0,_modules_calculator__WEBPACK_IMPORTED_MODULE_4__["default"])('.calculating');
